...
function LondonLandingPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'We buy houses fast in London for cash. Sell your London property in 24 hours. No estate agent fees, no chains, guaranteed completion. Get your free cash offer today.')
    } else {
      const meta = document.createElement('meta')
      meta.name = 'description'
      meta.content = 'We buy houses fast in London for cash. Sell your London property in 24 hours. No estate agent fees, no chains, guaranteed completion. Get your free cash offer today.'
  ...
  const londonAreas = [
    ...
    'Greenwich', 'Lewisham', 'Southwark', 'Lambeth', 'Wandsworth', 'Merton',
    'Kingston upon Thames', 'Richmond upon Thames', 'Hounslow', 'Hillingdon',
    'Ealing', 'Brent', 'Harrow', 'Barnet', 'Enfield', 'Haringey'
  ]
        ...
        <div className="relative z-10 container mx-auto px-6 text-center text-white">
          ...
          >
            <div className="mb-8">
              <img 
                src={logoImg} 
                alt="Same Day Home Buyer - London Cash House Buyers" 
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              ...
              <span className="block text-orange-400 mt-2">London</span>
            </h1>
            
            <p className="text-xl md:text-2xl mb-8 text-blue-100 leading-relaxed max-w-3xl mx-auto">
              We buy properties in all areas of London for cash. Get your guaranteed offer in 2 hours, 
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-2xl mx-auto mb-12">
              <Input
                type="text"
                placeholder="Enter your London property postcode"
                value={address}
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span>Trusted by 2,500+ London homeowners</span>
              </div>
              <div className="flex items-center space-x-2">
                <Star className="h-5 w-5 text-yellow-400" />
                <span>4.9/5 rating from London clients</span>
              </div>
              <div className="flex items-center space-x-2">
                <Award className="h-5 w-5 text-orange-400" />
                <span>£150M+ invested in London properties</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              We Buy Houses in All London Boroughs
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              From the City of London to outer boroughs, we purchase properties across all 32 London boroughs.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
            Join thousands of satisfied London homeowners who chose the fast, hassle-free way to sell.
          </p>
