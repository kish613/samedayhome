...
function ManchesterLandingPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'We buy houses fast in Manchester for cash. Sell your Manchester property in 24 hours. No estate agent fees, no chains, guaranteed completion. Get your free cash offer today.')
    } else {
      const meta = document.createElement('meta')
      meta.name = 'description'
      meta.content = 'We buy houses fast in Manchester for cash. Sell your Manchester property in 24 hours. No estate agent fees, no chains, guaranteed completion. Get your free cash offer today.'
  ...
  const manchesterAreas = [
    'Manchester City Centre', 'Salford', 'Trafford', 'Stockport', 'Tameside', 'Oldham',
    'Rochdale', 'Bury', 'Bolton', 'Wigan', 'Chorlton', 'Didsbury',
    'Withington', 'Fallowfield', 'Rusholme', 'Hulme', 'Ancoats', 'Northern Quarter',
    'Castlefield', 'Deansgate', 'Piccadilly', 'Oxford Road'
  ]
        ...
        <div className="relative z-10 container mx-auto px-6 text-center text-white">
          ...
          >
            <div className="mb-8">
              <img 
                src={logoImg} 
                alt="Same Day Home Buyer - Manchester Cash House Buyers" 
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              ...
              <span className="block text-orange-400 mt-2">Manchester</span>
            </h1>
            
            <p className="text-xl md:text-2xl mb-8 text-blue-100 leading-relaxed max-w-3xl mx-auto">
              We buy properties in all areas of Manchester for cash. Get your guaranteed offer in 2 hours, 
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-2xl mx-auto mb-12">
              <Input
                type="text"
                placeholder="Enter your Manchester property postcode"
                value={address}
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span>Trusted by 1,800+ Manchester homeowners</span>
              </div>
              <div className="flex items-center space-x-2">
                <Star className="h-5 w-5 text-yellow-400" />
                <span>4.9/5 rating from Manchester clients</span>
              </div>
              <div className="flex items-center space-x-2">
                <Award className="h-5 w-5 text-orange-400" />
                <span>£85M+ invested in Manchester properties</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6">
              We Buy Houses Across Greater Manchester
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              From Manchester city centre to surrounding boroughs, we purchase properties across all areas of Greater Manchester.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Sell Your Manchester Property?
          </h2>
          <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
            Join thousands of satisfied Manchester homeowners who chose the fast, hassle-free way to sell.
          </p>
