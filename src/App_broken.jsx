      ...
      <section className="property-showcase-section py-12 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-blue-900 mb-4">Recent Property Purchases</h2>
          ...
          >
            ...
            <div className="properties-showcase-stats grid grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="h-full bg-transparent border-0 relative overflow-hidden shadow-none hover:shadow-none"
                    style={{
                      background: 'transparent'
                    }}
              >
                <CardContent className="p-6 text-center relative z-10 h-full flex flex-col justify-center bg-transparent">
                  {/* Glass background layers */}
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-600/30 via-blue-800/40 to-blue-950/70 rounded-lg"></div>
                  <div className="absolute inset-0 bg-gradient-to-t from-blue-950/40 via-blue-900/30 to-blue-500/20 rounded-lg"></div>

                  {/* Subtle inner glow */}
                  <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-white/40 to-transparent rounded-full -translate-y-4 translate-x-4 opacity-95"></div>

                  {/* Main content */}
                  <div className="relative z-10">
                    <div className="mb-4">
                      <span className="properties-stat-value text-3xl lg:text-4xl font-bold text-white drop-shadow-lg block">
                        200+
                      </span>
                      <span className="properties-stat-value text-2xl lg:text-3xl font-bold text-blue-50 drop-shadow-md">
                        Properties
                      </span>
                    </div>
                    <span className="properties-stat-copy text-sm text-blue-100 font-medium leading-relaxed drop-shadow-sm">
                      Bought nationwide
                    </span>
                  </div>

                  {/* Enhanced hover effects */}
                  <div className="absolute inset-0 bg-gradient-to-t from-blue-400/20 via-transparent to-blue-200/20 opacity-0 hover:opacity-100 transition-opacity duration-500 rounded-lg"></div>
                </CardContent>
              </Card>
              ...
              >
                <CardContent className="p-6 text-center relative z-10 h-full flex flex-col justify-center bg-transparent">
                  ...
                  <div className="relative z-10">
                    <div className="mb-4">
                      <span className="properties-stat-value text-2xl lg:text-3xl font-bold text-white drop-shadow-lg block">
                        Average completion
                      </span>
                    </div>
                    <span className="properties-stat-copy text-2xl lg:text-3xl font-bold text-blue-50 drop-shadow-md block">
                      7 days
                    </span>
                    <span className="properties-stat-copy text-sm text-blue-100 font-medium leading-relaxed drop-shadow-sm block mt-1">
                      from offer
                    </span>
                  </div>
